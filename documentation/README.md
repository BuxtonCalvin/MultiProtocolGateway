...
- [influxdb_advanced_features.md](bridges/InfluxDB/influxdb_advanced_features.md) -  Advanced features for configuring the InfluxDB Bridge
- [influxdb_example.md](bridges/InfluxDB/influxdb_example.md) -  Example config for the InfluxDB Bridge
- [troubleshooting_influxdb.md](bridges/InfluxDB/troubleshooting_influxdb.md) -  Troubleshooting the InfluxDB Bridge
...
- [mqtt_writeback_to_inverter.svg](bridges/MQTT/mqtt_writeback_to_inverter.svg) - Write back process for MQTT
- [write_enabled_flow.svg](bridges/MQTT/write_enabled_flow.svg) - Flow Chart of the write back process

#### JSON

- [config.json_out.example](bridges/JSON/config.json_out.example) -  Example config for the JSON Bridge
- [json_out_example.md](bridges/JSON/json_out_example.md) -  Configuring the JSON Bridge
...
- [EG4-18KPV-12LV-Modbus-Protocol.pdf](3rdparty/protocols/EG4-18KPV-12LV-Modbus-Protocol.pdf)
- [EG4-LL-MODBUS-Communication-Protocol.pdf](3rdparty/protocols/EG4-LL-MODBUS-Communication-Protocol.pdf)
...
- [PACE-CAN-communication-protocol（PACE-CAN-TY）-20161216-.pdf](3rdparty/protocols/PACE-CAN-communication-protocal%EF%BC%88PACE-CAN-TY%EF%BC%89-20161216-.pdf)
