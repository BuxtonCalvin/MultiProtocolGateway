...
SEED_DESCRIPTIONS: dict[str, str] = {
    ...
    "send_holding_register": "When true, holding register values are included in the data published by this transport.",
    "send_input_register": "When true, input register values are included in the data published by this transport.",
    ...
    "write": "Enable write mode for this transport — allows sending values back to the device.",
    "write_enabled": "Alias for write — enable register write operations for this transport.",
