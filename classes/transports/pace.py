# Description: This module uses a long obsolete CRC-16 algorithm that is not compatible with the standard CRC-16 implementations in pymodbus and elsewhere.
# File: pace.py
#
