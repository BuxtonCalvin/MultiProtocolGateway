...
- InfluxDB
[`documentation/usage/bridges\InfluxDB\influxdb_advanced_features.md`](\documentation\bridges\InfluxDB\influxdb_advanced_features.md)

[`documentation/usage/bridges\InfluxDB\troubleshooting_influxdb.md`](\documentation\bridges\InfluxDB\troubleshooting_influxdb.md)

- TimeScaledDB
[`documentation/usage/bridges\InfluxDB\timescaledb_protocol_gateway.md`](\documentation\bridges\TimeScaleDB\timescaledb_protocol_gateway.md)
...
For a full list of tested devices and community-reported compatibility, see [`documentation/usage/devices_and_protocols.csv`](\documentation\usage\devices_and_protocols.csv).
...
- It is much easier and far less error prone to install PPG with its associated bridges via docker compose.  A full docker stack is available see [`documentation/docker/docker-compose.yml`](\documentation\docker/docker-compose.yml).  Make sure to also install the accompanying configuration files .env, mosquitto.conf and PPG.yaml (Grafana provisioning).  However, if you want to install without Docker, please read the following:
...
For a complete monitoring stack — PPG + TimescaleDB + InfluxDB + MQTT + pgAdmin + Chronograf + Grafana — see the included [`documentation/docker/docker-compose.yml`](\documentation\docker/docker-compose.yml) in this repository.
...
Full documentation for the compose stack is in [`documentation/docker/docker-compose.yml`](\documentation\docker\docker-compose.yml).
...
Find more protocol documentation here:  [`documentation\usage\protocols.md`](\documentation\usage\protocols.md)
...
Full configuration documentation: [`documentation\usage\transports.md`](\documentation\usage\transports.md)

For manufacturer device-specific wiring and installation guides: [/documentation/devices](\documentation\devices)
